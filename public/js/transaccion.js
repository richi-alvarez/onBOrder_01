...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(pago) {
        asistencia.addEventListener('click', pagarAsistencia);
    }else{
    const pago = document.getElementById('#epayco');
    asistencia.addEventListener('click', pagarAsistencia);
    }

});

function pagarAsistencia(e) {
    e.preventDefault();
console.log("pagar con epayco")
    ...
    //link de la reunin
    //         button.innerHTML = "paga a qui";
    //         button.setAttribute("id","epayco");
